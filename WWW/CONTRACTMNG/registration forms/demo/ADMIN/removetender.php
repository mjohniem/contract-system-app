...
-->
      ...
      <div id="sub" style=" text-align:center"><input name="submit" type="submit"  id="submit" tabindex="5" value="REMOVE THE TENDER" style="background-color:#7CE9CB; border:double solid; text-align:center">
...
try{
		...
		if($no>0 )
			{		 
				$sql="DELETE FROM tender WHERE rname=:rname";
				
				$query=$con->prepare($sql);
				$query->execute(array(':rname'=>$refname));
					echo'<script type="text/javascript">
							window.alert("You have successfully deleted the tender!")
							</script>';		
			}
		else
			{
