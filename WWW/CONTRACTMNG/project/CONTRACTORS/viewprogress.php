...
try 
	{
		//Creating connection for mysql
			...
			$query = "SELECT completion AS Percentage Completion, Apaid AS Amount Paid, Aleft AS Amount Left, expdate AS Expected Finish date FROM progress";   //first pass just gets the columnnames 
			print "<table style="border: #313131; 2px solid padding: 5px; margin-left:50px"> \n";  
