						...
						<table width="100%" height="300" border="2px" cellpadding="5" cellspacing="4" bordercolor="#000000" bordercolorlight="#666666" bordercolordark="#666666" bgcolor="#FFFFFF" frame="border" rules="cols">
							  ...
							  <br /><br /><br /><br /><br /><br />
								...
								<td width="635" rowspan="2" align="center" valign="middle" style="background-image: url(images/Flowers_Nature_Landscape.jpg); cursor:auto; richness:inherit"><p><br />
								  ...
								  <table width="535" height="158" border="0"  cellpadding="10" cellspacing="1" style="margin-left:-130px; padding-top: -30px;">
								<tr class="tableheader">
								<td height="33" colspan="2" align="center" class="style11">Update Cancellation Details of Contract </td>
								</tr>
								<tr class="tablerow">
								<td width="154" height="43" align="right"><span class="style11">Ref. Number of Contract</span> </td>
								<td width="338"><input name="refname" type="text" size="50" maxlength="50"></td></tr>
								<tr class="tablerow" style="color: #000000">
								<td height="38" align="right"><span class="style11">Cancel Detail</span></td>
								<td><input name="cdetails" type="radio" value="cancelled" required>Calcelled
								<input name="cdetails" type="radio" value="Null" required>Null</td></tr>
...
try
		{
			...
			$count->bindParam(':refname',$n);
			$count->execute();
			$no=$count->rowCount();		
			if($no==0 ) 
				{		 
					$sql="INSERT INTO cancellation(refname, cdetails) VALUES(:refname, :cdetails)";
					$query=$con->prepare($sql);
					$query->execute(array(':refname'=>$n, ':cdetails'=>$det));
					if(isset($_POST['submit']))
								{
								echo'<script type="text/javascript">
										window.alert("You have successfully updated cancellation details of the contract!");
									</script>';
								}
				}
