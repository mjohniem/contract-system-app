			...
			<ul>
				...
				<li>
					...
					<ul>
						...
						<li>
							<a href="adminplogin.php">Admin panel</a>
						</li>
						<li>
						...
						<table width="100%" height="300" border="2px" cellpadding="5" cellspacing="4" bordercolor="#000000" bordercolorlight="#666666" bordercolordark="#666666" bgcolor="#FFFFFF" frame="border" rules="cols">
							  ...
							  <br /><br /><br /><br /><br /><br />
								...
								<td width="635" rowspan="2" align="center" valign="middle" style="background-image: url(images/Flowers_Nature_Landscape.jpg); cursor:auto; richness:inherit"><p><br />	
								  ...
								  <table width="535" height="119" border="0"  cellpadding="10" cellspacing="1" style="margin-left:-60px; padding-top: -30px;">
								<tr class="tableheader">
								<td height="33" colspan="2" align="center"><span class="style11">Delete Invitation </span></td>
								</tr>
								<tr class="tablerow">
								<td width="166" height="43" align="right"><span class="style11">Title of the Invitation </span> </td>
									...
									<?php
										...
										try{
												...
												if(isset($_POST['submit']))
													{
														echo("You have successfully deleted the Invitation!");
													}
													else
													{
														echo("No such Invitation In the Database!");
													}
