		...
		<div id="header" >
			<ul>
				...
				<li>
					...
					<ul>
						<li>
							<a href="stafflogin.html">Official Staffs</a>
						</li>
							  ...
							  <br /><br /><br /><br /><br /><br />
								<td width="228" height="288">
								  <blockquote><blockquote>
									...
									<span class="style11">Add Contract </span></span><br />
								      <br />
								  ...
								  <blockquote><blockquote>
								    <div align="center"  style="width: 120px; border:#000000 2px double solid; height: 100px; background-color:#A6CECA; padding-top:20px; ">
									<span class="style10 style11">Update Cancel Detais Contract </span><a href="cancelcontract.php" onclick=show()><img src="images/rexpand.PNG" style="margin-left:100px"></a></div>
								  </blockquote>
							    </blockquote>	
								  <p>&nbsp;</p>
								  <blockquote><blockquote>
								    <div align="center"  style="width: 120px; border:#000000 2px double solid; height: 100px; background-color:#A6CECA; padding-top:20px; ">
									<span class="style10"><br />
									<span class="style11">Delete Contract</span><a href="deletecontract.php" onclick=show()><img src="images/rexpand.PNG" style="margin-left:100px"></a> </span><br />
								      <br />
								    </div></blockquote>
							    </blockquote>
								  <p>&nbsp;</p>
								  <blockquote><blockquote>
								    <div align="center"  style="width: 120px; border:#000000 2px double solid; height: 100px; background-color:#A6CECA; padding-top:20px; ">
									<span class="style10"><br />
									<span class="style11">Delete Invitation</span><a href="deleteinvitation.php" onclick=show()><img src="images/rexpand.PNG" style="margin-left:100px"></a> </span><br />
								      <br />
								    </div></blockquote>
							    </blockquote></td>
								
								<td width="635" rowspan="2" align="center" valign="middle" style="background-image: url(images/Flowers_Nature_Landscape.jpg); cursor:auto; richness:inherit"><p>&nbsp;</p>
								  <p>&nbsp;</p>
								  <p><br />	
						            <br />	
							      </p><form action="" method="POST">
								  <table width="535" height="158" border="0"  cellpadding="10" cellspacing="1" style="margin-right:-160px; padding-top: -30px;">
								<tr class="tableheader">
								<td height="33" colspan="2" align="center"><span class="style11">Add Invitation Messages </span></td>
								</tr>
								<tr class="tablerow">
								<td width="154" height="43" align="right"><span class="style11">Title of Invitation</span></td>
								<td width="338"><input name="title" type="text" id="title" size="50" maxlength="50" required></td></tr>
								<tr class="tablerow">
								<td height="38" align="right"><span class="style11">Invitation Message</span> </td>
								<td><textarea name="details" cols="50" id="file" required></textarea></td></tr>
								
								<tr class="tableheader"><td height="39" colspan="2" align="center"><input name="submit" type="submit" value="Update" style="font-size:24px; padding:10px 10px; "></td>
								</tr>
								</table></form>	
									<?php
									...
									try{
											...
											$count=$con->prepare("SELECT  title FROM invitation WHERE title=:title");
											$count->bindParam(":title",$name);
											$count->execute();
											$no=$count->rowCount();
											if($no==0 )
												{		 
													$sql="INSERT INTO invitation(title, details ) VALUES(:title, :details)";
													$query=$con->prepare($sql);
													$query->execute(array(':title'=>$name, ':details'=>$msg));
														if(isset($_POST['submit']))
													{
														echo'<script type="text/javascript">
														window.alert("You have successfully added the Invitation!")
														</script>';
													}									
												...
												{
													echo'<script type="text/javascript">
														window.alert("The Invitation already exist in our database!")
														</script>';
								  ...
								  <blockquote>
								    <div align="center"  style="width: 120px; border:#000000 2px double solid; height: 100px; background-color:#A6CECA; padding-top:20px; ">
									<span class="style10"><br />
									<span class="style11">View Contract</span><a href="viewcontract.php" onclick=show()><img src="images/lexpand.PNG" style="float:left;" ></a> </span><br />
								      <br />
								    </div></blockquote>
								    <p>&nbsp;</p>
								  ...
								  <blockquote>
								    <div align="center"  style="width: 160px; border:#000000 2px double solid; height: 100px; background-color:#A6CECA; padding-top:20px; "><span class="style10"><br />
								        <span class="style11">Add Invitation Information<a href="invitation.php" onclick=show()><img src="images/lexpand.PNG" style="float:left;" ></a> </span></span><br />
								      <br />
								    </div>
									</blockquote>
								  <p>&nbsp;</p>
