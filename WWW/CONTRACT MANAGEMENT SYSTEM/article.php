		...
		<div id="secnav">
			...
			<div id="employees" style="overflow: auto; height: 350px;>
				...
				<table width="100%" border="2px" align="center"  cellpadding="5" cellspacing="4" bordercolor="#000000" bordercolorlight="#666666" bordercolordark="#666666" bgcolor="#FFFFFF" frame="border" rules="cols">
							  ...
							  <tr>
												<td width="580" height="50" align="center"><p class="style1 style3" style="text-align:center"><strong>View the Invitation Information</strong><br />
				...
				try 
					{
						//Creating connection for mysql
							...
							$query = "SELECT id,details FROM invitation";   //first pass just gets the columnnames 
							print "<table style='border:2px solid black; padding-left:8px'> \n";  
							...
							foreach($data as $row)
								{
									...
									foreach ($row as $name=>$value)
										{
											print "
													<td><p  style='padding-left: 5px; padding-right: 5px; border-right:2px solid black;'>$value </p></td>
														</form>\n"; 
										} // end field loop   
												print " </tr> \n";  
								} // end record loop  
						...
						catch(PDOException $e) 
							{
								echo 'No Results Found ';  
									...
									<tr></td>
												<td width="580" height="50" align="center"><p class="style1 style3" style="text-align:center"><strong>List of Cancelled Contracts</strong><br />
				...
				try 
					{
						//Creating connection for mysql
							$con = new PDO("mysql:host=$dbhost;dbname=$dbname", $dbuser, $dbpass);  
							$con->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
							$query = "SELECT id,refname  FROM cancellation";   //first pass just gets the columnnames 
							print "<table style='border:2px solid black; padding-left:8px'> \n";
							print"<tr  cellspacing=3px; >
											<th style='border-right:2px solid black;'>Id</th>
											<th style='border-right:2px solid black;'>Reference Names of Cancelled Contracts</th>
											</tr>\n";							
							$result = $con->query($query);  //return only the first row (we only need field names)  
							$row =$result->fetch(PDO::FETCH_ASSOC);  
							//print " <p align=justify class=product-compare style20 style22>Online Contract in our Offer</p> \n";
							...
							foreach($data as $row)
								{
									...
									foreach ($row as $name=>$value)
										{
											echo "
													<td style='padding-left: 5px; padding-right: 5px; border-right:2px solid black;'><p style3>$value </p></td>
														</form>\n"; 
										} // end field loop   
												print " </tr> \n";  
								} // end record loop  
