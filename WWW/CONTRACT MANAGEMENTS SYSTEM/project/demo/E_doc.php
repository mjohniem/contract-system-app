		...
		<div id="secnav">
			...
			<div id="employees" style="height: 400px; overflow: auto;">
						...
						<table width="100%" height="300" border="2px" cellpadding="5" cellspacing="4" bordercolor="#000000" bordercolorlight="#666666" bordercolordark="#666666" bgcolor="#FFFFFF" frame="border" rules="cols">
							...
							<div style="margin-left:15%;  display:<?php if ($prodadd=="success") echo "none"; ?>;">
								 <form class="form-data" id="upload" name="upload" action="E_doc.php" method="POST" enctype="multipart/form-data">
									  <table width="450" height="158" border="0"  cellpadding="10" cellspacing="1" style="margin-right:-160px; padding-top: -30px;">
									<tr class="tableheader">
									<td height="33" colspan="2" align="center" class="style11">Add Online Documents </td>
									</tr>
									<tr class="tablerow">
									<td width="154" height="43" align="right"><span class="style11">Title of Document </span> </td>
									<td width="338"><input name="title" type="text" id="title" size="50" maxlength="50" required></td></tr>
									<tr class="tablerow">
									<td height="38" align="right"><span class="style11">E-Document</span></td>
									<td><input name="file" type="file" id="file" size="50" maxlength="50" required></td></tr>
									
									<tr class="tableheader">
									<td height="39"  align="left">
									<input type="reset" value="Clear" style=" font-weight:bold; text-align:center; color:#008000;font-size:24px; padding:10px 10px;">
									</td>
									<td height="39"  align="right">
									<input name="submit" type="submit" value="Add Doc" style="font-weight:bold; text-align:center; color:#008000;font-size:24px; padding:10px 10px; "></td>
									</tr>
									</table>
													<?php
										if ($prodadd=="fail")
											{
												echo"<span  style='color:red; margin-left:5px; '>couldn't add the advert</span>"; 
											} 
									?>	
								</form>
							</div>
							<br />
								<div id="success" >
									...
									<?php
									 if ($prodadd=="success") 
										 echo " <br><br><span style='border:1px solid #00ff00; border-radius:10px; padding:10px; background-color:#e0eee0;  margin-left:20%;color:#008000; font-style:italic;'> The <a href='#'>File</a> has been successfully posted.</span>"; 
									?>
								</div>
									<?php
										session_start();
													...
													if($_FILES['file']['size']<200000)
															{
																...
																{
																 // echo "the Document ". $_FILES['file']['name']." is already there";
																  echo'<script type="text/javascript">
																		window.alert("The Document is already there!")
																		</script>';
																}
																else if(move_uploaded_file($_FILES['file']['tmp_name'],'uploads/'.$_FILES['file']['name']))
																{
																	...
																	$spart=$_FILES['file']['name'];					
																		...
																		$sql = "INSERT INTO docs (title, file) VALUES ('$tit','{$spart}')";
																		$result = mysql_query($sql);
																			...
																			if(!$result)
																			...
																			else
																				{
																						 ...
																						 echo'<script type="text/javascript">
																						window.alert("You have added the Document !")
																						</script>';
																				}
																}
															}
								  ...
								  <blockquote class="style11">
								    <div align="center"  style="width: 120px; border:#000000 2px double solid; height: 100px; background-color:#A6CECA; padding-top:20px; ">
									<span class="style10">Delete Online Documents<a href="deletedoc.php" onclick=show()><img src="images/lexpand.PNG" style="float:left;" ></a> </span><br />
								      <br />
					      </div></blockquote>					  </tr>
			  </table>
