...
catch(e) 
{
  c('Error') 
	...
	<script>
		...
		{
		//Function content goes here
		if(document.getElementById('expand6').style.display == 'none')
						...
						<table width="100%" height="300" border="2px" cellpadding="5" cellspacing="4" bordercolor="#000000" bordercolorlight="#666666" bordercolordark="#666666" bgcolor="#FFFFFF" frame="border" rules="cols">
							  ...
							  <br /><br /><br /><br /><br /><br />
											...
											foreach($data as $row)
												{
													...
													foreach ($row as $name=>$value)
														{
														print "
																	<td width=50%; cellspacing=3px;><p align=center color=black;>$value.'' </p></td>
																		</form>\n"; 
														} // end field loop   
																print " </tr> \n";  
												} // end record loop  
								...
								<p> <div id="expand2" style="color: #000000; display:none">
											...
											<tr class="tablerow">
											<td height="41" align="right" class="style11"><span class="style11">Id Number of the Finance Officer</span> </td>
											...
											<td class="style11"><input name="username" type="text" id="text"  size="50" maxlength="50" required></td></tr>
											<tr class="tablerow">
											<td width="154" height="43" align="right" class="style11"><span class="style11">Ref. Number of Contract</span> </td>
											<td width="338" class="style11"><input name="refname" type="text" size="50" maxlength="50" required></td></tr>
								...
								<td width="431" rowspan="2" align="center" valign="middle" style="background-image: url(images/Flowers_Nature_Landscape.jpg); cursor:auto; richness:inherit; color:#000000" ><blockquote>
								  ...
								  <div style="background-color:#CC99FF; width:180px; height:50px">
								    <p>&nbsp;</p>
								    <a href="javascript:;" onclick=show()>
								<p>User Calculator</p>
							      </a></div>
								  <p><div id="expand" style="display:none">
										<div class="box" >
										<div class="display" ><input type="text" readonly size="18" id="d"></div>
										<div class="keys" style="color: #000000">
										...
										</div></p><div onMouseMove="color: #ffffff" style="background-color:#CC99FF; width:200px; height:130px" >
										  <p>&nbsp;</p>
										  <a href="javascript:;" onclick=show6()>
										  
										  <p>Generate Amount</p>
										  <p> Given and Remaining</p>
										  <p> for Contractors</p></a>
										</div>
										
										  <div id="expand6" style="color: #000000; display:none">
										  <form action="generateamt.php" method="POST"> 
											<table width="500" height="260" border="0"  cellpadding="10" cellspacing="1" style="margin-left:-50px;">
											<tr class="tableheader">
											<td height="33" colspan="2" align="center" class="style11"><span class="style11">Fill in the Form </span></td>
											</tr>
											...
											<tr class="tableheader"><td height="39" colspan="2" align="center" class="style11">
												 <input name="submit"  type="submit" value="Generate Report" style="font-size:24px; padding:10px 10px;"/>	
								  ...
								  <div onMouseMove="color: #ffffff" style="background-color:#CC99FF; width:200px; height:100px" > <p><br /> 
								    </p>
								    <a href="javascript:;" onclick=show3()><p>Update Cost For</p>
								    <p> phases of Contractors</p></a>
								  </div>
								  <div id="expand3" style="color: #000000; display:none">
										<!-- Content Goes here -->
										<p>
										
										<!-- view balance left after minus the costed amt and amt given -->
										...
										<form action="updatecost.php" method="POST"> 
											...
											<td width="338" class="style11"><input name="refname" type="text" size="50" maxlength="50" required></td></tr>
											<tr class="tablerow">
											<td height="59" align="right" class="style11"><span class="style11">Title of the Contract</span>
											</td>
											<td class="style11"><br />
											...
											<tr class="tablerow">
											<td height="41" align="right" class="style11"><span class="style11"> Amount of Capital Given to Contractor</span> </td>
											<td class="style11"><input name="expamt" type="text" id="text"  size="50" maxlength="50" required></td></tr>
								...
								<td width="359" >
								  <blockquote class="style11">
								    <div onMouseMove="color: #ffffff" style="background-color:#CC99FF; width:200px; height:100px; color:#000000" >
									<p>&nbsp;</p>
									<a href="javascript:;" onclick=show4()><p>View Progress of </p>
									<p>Contractor </p></a>
								    </div>
									<p>
									<div id="expand4" style="color: #000000; display:none">
										<!-- Content Goes here -->
										<p><?php
										// configuration
											$dbhost 	= "localhost";
										...
										//Creating connection for mysql
											$con = new PDO("mysql:host=$dbhost;dbname=$dbname", $dbuser, $dbpass);  
											$con->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
											$query = "SELECT * FROM progress";   //first pass just gets the columnnames 
											print "<table class='table' style='border:2px solid black; float:left; padding-left:8px'> \n"; 
											print"<tr width=50%; cellspacing=3px; >
									...
									<div onMouseMove="color: #ffffff" style="background-color:#CC99FF; width:200px; height:100px; color:#000000 ">
									<p>&nbsp;</p>
									<a href="javascript:;" onclick=show5()><p>Costing for a Contract</p></a>
									</div>
									<div id="expand5" style="color: #000000; display:none">
										<!-- Content Goes here -->
										<p><form action="costing.php" method="POST"> 
											<table width="500" height="260" border="0"  cellpadding="10" cellspacing="1" style="margin-left:-50px;">
											<tr class="tableheader">
											<td height="33" colspan="2" align="center" class="style11"><span class="style11">Fill in the Form </span></td>
											</tr>
											...
											<td width="338" class="style11"><input name="refname" type="text" size="50" maxlength="50" required></td></tr>
											<tr class="tablerow">
											<td height="59" align="right" class="style11"><span class="style11">Title of the Contract</span></td>
											<td class="style11"><br />
											  <select  name="title" required>
											  <option>car</option>
											  <option>land</option>
											...
											<tr class="tablerow">
											<td height="41" align="right" class="style11"><span class="style11">Expected Amount of Capital</span> </td>
											<td class="style11"><input name="expamt" type="text" id="text"  size="50" maxlength="50" required></td></tr>
											<tr class="tablerow">
											<td height="41" align="right" class="style11"><span class="style11">Expected Finish Date</span> </td>
											<td class="style11"><input name="expdate" type="text" id="text"  size="50" maxlength="50" required></td></tr>
