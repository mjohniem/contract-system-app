			...
			<div id="employees" style="height: 400px; overflow: auto;">
						...
						<table width="100%" height="300" border="2px" cellpadding="5" cellspacing="4" bordercolor="#000000" bordercolorlight="#666666" bordercolordark="#666666" bgcolor="#FFFFFF" frame="border" rules="cols">
							  ...
							  <br /><br /><br /><br /><br /><br />
								    ...
								    <blockquote>
								      <blockquote>
								        <blockquote>
								          <blockquote>
								            <blockquote>
								              <p><span class="style11"><a href="adminnext.php">next page</a></span>		
							                  </p>
							                </blockquote>
								          </blockquote>
								        </blockquote>
								...
								<td height="33" colspan="2" align="center" class="style11"><span class="style11">Add New Contracts </span></td>
								</tr>
								<tr class="tablerow">
								...
								<tr class="tablerow">
								<td height="59" align="right" class="style11"><span class="style11">Description</span></td>
								<td class="style11"><br />
								  <textarea name="description" cols="37" required></textarea></td></tr>
								<tr class="tablerow">
								<td height="41" align="right" class="style11"><span class="style11">Expiration Date</span> </td>
								<td class="style11"><input name="expdate" type="text" id="text"  size="50" maxlength="50" required></td></tr>
								<tr class="tablerow">
								<td height="41" align="right" class="style11"><span class="style11">Title of The Contract</span> </td>
								<td class="style11"> <select  name="title" required>
											  <option>car</option>
											  <option>land</option>
											  <option>rent</option>
											  <option>event</option>
								...
								<tr class="tablerow">
								<td height="38" align="right" class="style11"><span class="style11">Cancel Detail</span></td>
								<td class="style11"><input name="cdetails" type="text" size="50" maxlength="50" required></td></tr>
								
								<tr class="tableheader"><td height="39" colspan="2" align="center" class="style11"><input name="submit" type="submit" value="Add Contract" style="font-size:24px; padding:10px 10px; "></td>
								</tr>
								</table></form>				
