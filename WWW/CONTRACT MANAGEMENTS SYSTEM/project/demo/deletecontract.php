						...
						<table width="100%" height="300" border="2px" cellpadding="5" cellspacing="4" bordercolor="#000000" bordercolorlight="#666666" bordercolordark="#666666" bgcolor="#FFFFFF" frame="border" rules="cols">
							  ...
							  <br /><br /><br /><br /><br /><br />
								...
								<td width="635" rowspan="2" align="center" valign="middle" style="background-image: url(images/Flowers_Nature_Landscape.jpg); cursor:auto; richness:inherit"><p><br />	
								  ...
								  <p><br />	
							        <br />	
							      </p><form action="" method="POST" type="delete">
								  <table width="535" height="119" border="0"  cellpadding="10" cellspacing="1" style="margin-left:-120px; padding-top: -30px;">
								<tr class="tableheader">
								<td height="33" colspan="2" align="center"><span class="style11">Delete Contract  </span></td>
								</tr>
								<tr class="tablerow">
								<td width="166" height="43" align="right"><span class="style11">Ref. Number of the Contract </span> </td>
								<td width="326"><input name="refname" type="text" id="refname" size="50" maxlength="50" required></td></tr>
								...
								<tr class="tableheader"><td height="39" colspan="2" align="center"><input name="submit" type="submit" value="Delete" style="font-size:24px; padding:10px 10px; "></td>
									...
									<?php
										...
										try{
												...
												$query->execute(array(':refname'=>$refname));
												if(isset($_POST['submit']))
													{
														echo("You have successfully deleted the contract!");
														
													}
													else
													{
														echo("No such Contract In the Database!");
													}
											}
