	...
	<div id="page">
		...
		<div id="secnav">
			...
			<div id="employees" style="height: 400px; overflow: auto;">
						...
						<table width="100%" height="901" border="2px" cellpadding="5" cellspacing="4" bordercolor="#000000" bordercolorlight="#666666" 							bordercolordark="#666666" bgcolor="#FFFFFF" frame="border" rules="cols">
					  
							  <tr>
							  <br /><br /><br /><br /><br /><br />
								<td width="111" height="889">
								...
								<td width="300" rowspan="2" align="center" valign="middle" style="background-color:#C2B1C2" ><p class="style11">&nbsp;</p>
								  <p class="style11" ><span class="style11"><a href="carapplication.php">Car Agreements </a></span></p>
						        ...
						        <p class="style11"><span class="style11"><a href="constructionapplication.php">Construction Agreements  </a></span> </p></td>
								<td width="514" rowspan="2" align="center" valign="middle" ><div align="center" class="style12" id="homepage-content">
						<h1 class="style2">Car Selling Contract</h1>
							<p class="style1">Contract for Purchase of a Car</p>
							...
							<p>Phone<input type="text" name="phone" id="phone"  size="50" maxlength="50" required>
							  ...
							  <p>The Seller hereby conveys to the LU full ownership and title to the motor vehicle described thereafter:</p>
							 
							<p>Description of Motor Vehicle Sold:</p>
							<p>Year
							  <input type="text" name="year" id="year"  size="50" maxlength="50" required> 
						  </p>
							<p>Make 
							  <input type="text" name="make" id="make"  size="50" maxlength="50" required>
							</p>
							<p>Model 
							  <input type="text" name="model" id="model"  size="50" maxlength="50" required>
							</p>
							<p>VIN:   
							  <input type="text" name="vin" id="vin"  size="50" maxlength="50" required>
							</p>
							
							<p>The Buyer hereby agrees to pay  <input type="text" name="deposit" value="deposit" required>
						      , and 
							   <input type="text" name="installment" value="installment" required> on 
							the <input type="text" name="day" value="day" required> day</p>
							<p> of each month until all payments made to
							  the LU of total
							  <input type="text" name="ammount" value="total cash" required>
							  .</p>
							<p>If Buyer fails to make a payment on or before its due date, a late 
					fee of 2% shall be added to the balance due and shall be payable 
					immediately.</p>
					<p>Both parties hereby agree that this is an "as-is" sale, with no warranties of any kind expressed or implied.</p>
					<p>This agreement shall be governed by the laws of the State of Laikipia University.</p>
					<p><i>This contract is tagged with these keywords: car selling contract, car, automobile, motor vehicle, bill of sale</i></p>
