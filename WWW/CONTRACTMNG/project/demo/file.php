			...
			<ul>
				...
				<li>
					...
					<ul>
						...
						<li>
							<a href="afinancelogin.php">Finance Officer Panel</a>
						</li>
			...
			<div id="employees" style="height: 400px; overflow: auto;">
						...
						<table width="100%" height="300" border="2px" cellpadding="5" cellspacing="4" bordercolor="#000000" bordercolorlight="#666666" bordercolordark="#666666" bgcolor="#FFFFFF" frame="border" rules="cols">
							  ...
							  <br /><br /><br /><br /><br /><br />
								...
								<td><input name="doc" type="file" id="file" size="50" maxlength="50" required></td></tr>
								
								<tr class="tableheader"><td height="39" colspan="2" align="center"><input name="submit" type="submit" value="Add Doc" style="font-size:24px; padding:10px 10px; "></td>
								</tr>
								</table></form>
